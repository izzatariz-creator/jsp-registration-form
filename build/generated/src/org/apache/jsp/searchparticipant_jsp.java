...
public final class searchparticipant_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
            ...
            try {
                ...
                ResultSet rs = stmt.executeQuery("SELECT * FROM assignment.participant WHERE name='" + name + "'");
